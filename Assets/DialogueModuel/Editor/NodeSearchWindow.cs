...
namespace DialogueSystem.Editor
{
    public class NodeSearchWindow : ScriptableObject, ISearchWindowProvider
    {
        ...
        public List<SearchTreeEntry> CreateSearchTree(SearchWindowContext context)
        {
            ...
            {
                new SearchTreeGroupEntry(new GUIContent("Dialogue Node"), 0), // 최상위 그룹 엔트리
                new SearchTreeGroupEntry(new GUIContent("Dialogue", EditorGUIUtility.FindTexture("d_FilterByType")), 1), // 두 번째 그룹 엔트리
