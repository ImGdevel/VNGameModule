...
namespace DialogueSystem
{
    public class DialogueManager : DialogueGetData
    {
        ...
        private void RunNode(DialogueNodeData _nodeData)
        {
            ...
            if (_nodeData.AvatarPos == CharacterPosition.Left && _nodeData.Character != null) { dialogueUIManager.SpriteLeft.SetActive(true); dialogueUIManager.SpriteLeft.GetComponent<Image>().sprite = _nodeData.Character.GetAvatar(_nodeData.AvatarPos, _nodeData.AvatarType); }
            if (_nodeData.AvatarPos == CharacterPosition.Right && _nodeData.Character != null) { dialogueUIManager.SpriteRight.SetActive(true); dialogueUIManager.SpriteRight.GetComponent<Image>().sprite = _nodeData.Character.GetAvatar(_nodeData.AvatarPos, _nodeData.AvatarType); }
